...
export const Footer = () => {
  return (
    <footer className="border-t border-slate-800/80 bg-[#05050A] py-8 px-6">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-slate-200">{PORTFOLIO_DATA.personal.name}</p>
          <p className="text-xs text-slate-500">{PORTFOLIO_DATA.personal.title}</p>
        </div>
